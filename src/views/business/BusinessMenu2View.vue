...
import TargetTopInput from '@/views/business/components/BusinessMenu2/TargetTopInput.vue';
import TableComponent from '@/views/business/components/BusinessMenu2/TableComponent.vue';
