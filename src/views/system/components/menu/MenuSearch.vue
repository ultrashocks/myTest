<template>
  <div class="input-wrap grid-4-menu">
    <div class="input-inner">
      <div class="inner-item">
        <label style="flex: 0 0 70px">메뉴 ID</label>
        <AppInput v-model="searchData.menuId" />
      </div>
      <div class="inner-item">
        <label>메뉴명</label>
      ...
      <div class="inner-item">
        <label style="flex: 0 0 70px">URL</label>
        <AppInput v-model="searchData.url" />
      </div>
      <div class="inner-item">
        <label>권한</label>
        <AppSelectBox
