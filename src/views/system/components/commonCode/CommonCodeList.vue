          ...
          <tbody>
            <tr
              ...
              :class="{
                ...
                add: addItemIds.includes(item.id) && currentState === 'add',
              }"
            ...
            >
              ...
              <td>
                <div class="td-col">
                  <template
                    v-if="
                      currentState === 'add' && addItemIds.includes(item.id)
                    "
                  >
                    <input
                ...
                <div class="td-col">
                  ...
                  <template v-else>
                    ...
                    <input
                      ...
                      @keydown.enter="saveEdit(item)"
                      :ref="
                        el => setEditInputRef(el, item.id, 'commonCodeName')
                      "
                      class="edit-input"
                    />
                  </template>
                ...
                <div class="td-col">
                  ...
                  <template v-else>
                    <div
                      class="td-col__text"
                      v-if="
                        editingRow !== item.id || editingField !== 'explain'
                      "
...
const addItemIds = ref([]);
const onAddCode = () => {
  currentState.value = 'add';
  selectRowId.value = '';
  const newId = randomKey();
  addItemIds.value.push(newId);
